...
class SpectrumBuilder:
    ...
    def build_export_columns(
        ...
        *,
        ...
        corrected_counts, normalized_counts, wavelengths, volts, frame_dark_level = self._build_processed_columns(adc_counts)
    ...
    def _build_processed_counts(
        ...
        corrected_counts, normalized_counts, _wavelengths, _volts, frame_dark_level = self._build_processed_columns(adc_counts)
    ...
    def _build_processed_columns(
        ...
        return corrected_counts, normalized_counts, wavelengths, volts, frame_dark_level
